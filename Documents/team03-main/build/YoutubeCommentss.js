...
export default class YoutubeCommentss extends GameScene {
    ...
    constructor(maxX, maxY, data) {
        ...
        for (let i = 0; i < sceneData.comments.length; i++) {
            this.comments.push(new YoutubeComment(sceneData.comments[i].author, sceneData.comments[i].content, sceneData.comments[i].img, sceneData.comments[i].likes));
...
;
//# sourceMappingURL=YoutubeCommentss.js.map