...
export default class YoutubePost extends GameScene {
    sprite;
    frameCount;
    frame;
    timeToNextFrame;
    ...
    constructor(maxX, maxY, data) {
        ...
        this.pause = true;
        this.likeButton = new ToggleButton(500, 500, './assets/yt-like-icon.png', './assets/youtube-liked-icon.png');
        this.liked = false;
        this.commentsButton = new Button(500, 725, './assets/yt-shorts-comment-icon.png');
...
//# sourceMappingURL=YoutubePost.js.map